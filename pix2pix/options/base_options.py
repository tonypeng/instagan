...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--upsample_conv_type', type=str, default='transpose', help='generator upsample convolution type [tranpose | resize]')
        parser.add_argument('--conv_dilation_G', type=int, default=1, help='generator convolution dilation')
